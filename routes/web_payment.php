...
Route::get('/getRandomPayment', 'PaymentController@getRandomPayment')->name('createRandomTransaction');
Route::get('/getPayment', 'PaymentController@getPayment')->name('createTransaction');

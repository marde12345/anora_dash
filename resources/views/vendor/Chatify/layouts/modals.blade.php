...
<div class="app-modal" data-name="delete">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="delete" data-modal='0'>
            <div class="app-modal-header">Apakah ingin menghapus ini?</div>
            <div class="app-modal-body">Anda tidak dapat mengembalikan lagi</div>
    ...
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="settings" data-modal='0'>
            <form id="updateAvatar" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="app-modal-header">Update pengaturan</div>
                <div class="app-modal-body">
                    {{-- Udate profile avatar --}}
                    <div class="avatar av-l upload-avatar-preview" style="background-image: url('{{ Auth::user()->PhotoProfile }}');"></div>
                    ...
                    <p class="divider"></p>
                    <p class="app-modal-header">Rubah warna {{ config('chatify.name') }}</p>

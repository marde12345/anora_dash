...
<head>
    ...
    <meta name="description" content="ANORA Your Data Solution">
    <meta name="author" content="ANORA">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">ANORA</div>
            </a>
            ...
            <!-- Nav Item - List Users -->
            <li class="nav-item {{ Nav::isRoute('dashboard.user.index') }}">
            ...
            <!-- Nav Item - List Users -->
            <li class="nav-item {{ Nav::isRoute('dashboard.user.create') }}">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{$message->from->photo_url}}" alt="">
                                        <div class="status-indicator bg-success"></div>
                                    </div>
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">{{$message->content}}</div>
                                        <div class="small text-gray-500">{{$message->from->name ." ". $message->from->last_name}} · {{$message->send_at}}</div>
                                    </div>
                                </a>
                                @endforeach
